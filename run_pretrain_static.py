...
"""
Pretrain  GPT2-2 in static graph mode.
"""
import argparse
import math
import os
...
MODEL_CLASSES = {
    "gpt": (GPT2ForPretraining, GPT2Tokenizer),
    "gpt-cn": (GPT2ForPretraining, GPT2ChineseTokenizer),
}
...
def init_static_with_params(model, dygraph_params, topo, prog=None):
    from tools import dygraph_params_to_static
            ...
            with paddle.static.device_guard('gpu:0'):
                ...
                if args.model_name_or_path in pretrained_models_list:
                    ...
                    model = guard(f'gpu:{args.pp_degree -1}')(
                        GPT2ForPretraining)(guard(f'gpu:0')(GPT2Model)(
                            **model_config))
                else:
                    model, _ = GPT2ForPretraining.from_pretrained(
                        args.model_name_or_path,
                        hidden_dropout_prob=args.hidden_dropout_prob,
